...
$episodes = '';
	...
	$data = '<div class="row">
							...
							<div id="myplayer" class="video" data-video="'.$array[0]['pic_path'].'">
								...
								<div class="thumbnail" id="thumbnail">
									...
									<div class="caption">
										...
										<div class="carousel-caption-text">Latest Episode '.$array[0]['sequence_no'] .'</div>
									</div>
								</div>
							</div>
				</div>
				<div class="col-lg-8 col-lg-offset-2">
					...
					<div class="detail-title"> <p> <span class="mv-title-left rd-gold-color">About:&nbsp;</span> <span class="mm-font">  '.$array[0]['description'].'</span> </p></div>
					<div class="rd-color div-episode-title">Episodes:</div>
